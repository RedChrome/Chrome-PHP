...
{
    const CHROME_VALIDATOR_EMAIL_DEFAULT_MAX_LENGTH = 'EMAILMAXLENGTH',
          CHROME_VALIDATOR_EMAIL_DEFAULT_MIN_LENGTH = 'EMAILMINLENGTH';

    const CHROME_VALIDATOR_EMAIL_DEFAULT_TOO_SHORT  = 'EMAILTOOSHORT',
          CHROME_VALIDATOR_EMAIL_DEFAULT_TOO_LONG   = 'EMAILTOOLONG',
          CHROME_VALIDATOR_EMAIL_DEFAULT_NOT_VALID  = 'EMAILNOTVALID';
