 ...
 * @subpackage Chrome.Design
 */
class Chrome_Design_Composite_Footer extends Chrome_Design_Composite_Abstract
{
    ...
    public function render(Chrome_Controller_Interface $controller) {
        return Chrome_Design::getInstance()->get('footer_start').parent::render($controller).Chrome_Design::getInstance()->get('footer_end');
    }
}