 ...
 * @version    $Id: 0.1 beta <!-- phpDesigner :: Timestamp [17.02.2013 17:04:02] --> $
...
class Chrome_Design_Composite_Content extends Chrome_Design_Composite_Abstract
{
    ...
    public function render(Chrome_Controller_Interface $controller) {
        return Chrome_Design::getInstance()->get('content_start').parent::render($controller).Chrome_Design::getInstance()->get('content_end');
    }
}