...
class IdentifierHelper implements Helper_Interface
{
    ...
    {
        if(!($resource instanceof \Chrome\Resource\Identifier_Interface)) {
            return null;
        }

        $link = $this->_resourceModel->findLinkByIdentifier($resource->getIdentifier());
...
interface Identifier_Interface extends Resource_Interface
{
    public function getIdentifier();
}

class Identifier extends Resource implements Identifier_Interface
{
    protected $_prefix = 'iden:';
