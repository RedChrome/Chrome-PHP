...
abstract class Chrome_Form_Abstract implements Chrome_Form_Interface
{
	...
	public function getCreationErrors( $elementName = null )
	{
		if( $elementName == null ) {
			...
			return isset( $this->_creationErrors[$elementName] ) ? $this->_creationErrors[$elementName] :
				array();
		}
	}
	...
	public function getValidationErrors( $elementName = null )
	{
		if( $elementName == null ) {
			...
			return isset( $this->_validationErrors[$elementName] ) ? $this->_validationErrors[$elementName] :
				array();
		}
	}
	...
	public function getReceivingErrors( $elementName = null )
	{
		if( $elementName == null ) {
			...
			return isset( $this->_receivingErrors[$elementName] ) ? $this->_receivingErrors[$elementName] :
				array();
		}
	}
	...
	public function getErrors( $elementName = null )
	{
		return array_merge( $this->getCreationErrors( $elementName ), $this->getReceivingErrors( $elementName ),
			$this->getValidationErrors( $elementName ) );
	}
	...
	public function hasErrors( $elementName, $errorName = null )
	{
		return ( $this->hasCreationErrors( $elementName, $errorName ) or $this->hasReceivingErrors( $elementName,
			$errorName ) or $this->hasValidationErrors( $elementName, $errorName ) );
	}
