...
class Chrome_Form_Element_Birthday extends Chrome_Form_Element_Abstract
{
    ...
    protected function _isValid()
    {
        ...
        {
            if($data[self::CHROME_FORM_ELEMENT_BIRTHDAY_NAMESPACE_MONTH] == null or $data[self::CHROME_FORM_ELEMENT_BIRTHDAY_NAMESPACE_YEAR] == null or
                 $data[self::CHROME_FORM_ELEMENT_BIRTHDAY_NAMESPACE_DAY] == null)
            {
                $isValid = false;
    ...
    public function isSent()
    {
        return true;
        /*
         * if($this->getData() !== null) { return true; } else { $this->_errors[] = self::CHROME_FORM_ELEMENT_ERROR_NOT_SENT; return false; }
         */
    }
