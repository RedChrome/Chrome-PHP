...
class Login extends \Chrome\Controller\ModuleAbstract
{
    ...
    {
        if($this->_applicationContext->getResponse() instanceof \Chrome\Response\Handler\JSONHandler) {
            ...
            $this->_controller->setExceptionHandler(new \Chrome\Exception\Handler\JSONHandler());
        } else {
