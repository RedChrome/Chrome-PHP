...
class AuthorisationAdapterSimpleModelDefaultTest extends Chrome_TestCase
{
    ...
    public function setUp()
    {
        $this->_model = new \Chrome\Model\Authorisation\Adapter\Simple\Database($this->_diContainer->get('\Chrome_Database_Factory_Interface'), $this->_diContainer->get('\Chrome_Model_Database_Statement_Interface'));
