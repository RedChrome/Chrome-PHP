...
('comment_block_sec', 'News', '30', 'integer', '', 0),
('Default_Design', 'Design', 'chrome', 'string', '', 0),
('default_user_group', 'Registration', '1', 'integer', '', 0),
...
('expiration', 'Registration', '604800', 'integer', '', 0),
('Gallery_Page_Limit', 'Gallery', '9', 'integer', '', 0),
('Meta_Desc', 'Site', '', 'string', '', 0),
('Meta_Keywords', 'Site', '', 'string', '', 0),
('News_Comment_Limit', 'News', '15', 'integer', '', 0),
('News_Page_Limit', 'News', '6', 'integer', '', 0),
